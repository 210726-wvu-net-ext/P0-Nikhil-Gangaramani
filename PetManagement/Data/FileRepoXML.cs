    ...
    public class FileRepoXML
    {
        ...
        public static List<Cat> Init(){
            List<Cat> cats = new List<Cat>(){
                new Cat(){Id=100, Name="Tolly", Dob=new DateTime(2018, 11, 12), Weight=9.0, CatType=CatType.Himalayan, FurType=FurType.Long, Gender=Gender.Male},
                ...
                new Cat(){Id=102, Name="Diamond", Dob=new DateTime(2020, 03, 12), Weight=6.0, CatType=CatType.American_Bobtail, FurType=FurType.Short, Gender=Gender.Female},
                new Cat(){Id=103, Name="Clifford", Dob=new DateTime(2015, 10, 22), Weight=9.0, CatType=CatType.Abyssian, FurType=FurType.NoFur, Gender=Gender.Male}
            };
            return cats;
        }
